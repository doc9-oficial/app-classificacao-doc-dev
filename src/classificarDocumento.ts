...
interface ClassificarDocumentoParams {
  parametro: string;
  filtro?: string;
}

async function classificarDocumento(params: ClassificarDocumentoParams): Promise<void> {
  try {
    ...
    console.log(`Executando classificarDocumento com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Classifica tipo de documento jurídico concluído com sucesso",
      resultado: {
...
export default classificarDocumento;
