...
interface DetectarCategoriaParams {
  parametro: string;
  filtro?: string;
}

async function detectarCategoria(params: DetectarCategoriaParams): Promise<void> {
  try {
    ...
    console.log(`Executando detectarCategoria com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Detecta categoria de documento concluído com sucesso",
      resultado: {
...
export default detectarCategoria;
